        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="clazzName" lay-verify="required" value="${clazz.clazzName}" placeholder="请输入标题" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="subjectId" lay-verify="required">
                        ...
                        <c:forEach items="${subjects}" var="subject">
                            <option value="${subject.id}" <c:if test="${clazz.subjectId == subject.id}">selected</c:if>>${subject.subjectName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="remark" placeholder="请输入标题" value="${clazz.remark}" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
